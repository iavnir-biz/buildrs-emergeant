      ...
      <div className="flex-1 bg-[#141414] border border-[#222222] rounded-[10px] flex flex-col overflow-hidden">
        {!activeSession ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-5 p-8">
            <div className="w-16 h-16 rounded-full bg-[#F5F0E8] flex items-center justify-center text-[#0A0A0A] font-bold text-[20px]">AO</div>
          ...
          <>
            ...
            <div className="border-b border-[#222222] px-4 py-3 flex items-center gap-3 flex-shrink-0">
              <div className="w-7 h-7 rounded-full bg-[#F5F0E8] flex items-center justify-center text-[#0A0A0A] text-[10px] font-bold flex-shrink-0">AO</div>
              <div>
