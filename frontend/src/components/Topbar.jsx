...
const BREADCRUMBS = {
  ...
  '/coaching/tickets': ['Coaching', 'Parler à un coach'],
  '/coaching/appel': ['Coaching', 'Réserver un appel'],
  '/coaching/ia': ['Coaching', 'Buildrs IA'],
  '/coaching/lab': ['Coaching', 'Lab Notes'],
  '/coaching/session': ['Coaching', 'Sessions Live'],
